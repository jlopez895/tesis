...
public interface RolRepository extends JpaRepository<Rol, Integer>{
	...
	@Query(value = "select * from roles where id in(SELECT p.id_rol_asoc FROM tesis.roles_permisos as rp inner join permiso as p on p.id=rp.id_permiso where id_rol=?)", nativeQuery = true)
