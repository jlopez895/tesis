...
app.controller('controllerPedidos', function ($scope, $filter, $http, $rootScope, $stomp, $window, URL_WS) {
	...
	var reqEstimulos = {
		method: 'GET',
		url: 'https://tesis-rn6b.onrender.com/api/final/estimulos/list',
		headers: {
	...
	var reqNotificaciones = {
		method: 'GET',
		url: 'https://tesis-rn6b.onrender.com/api/final/notificaciones/list/' + userDataFromLocalStorage.idUser,
		headers: {
			'Content-Type': 'application/json',
			'xauthtoken': userDataFromLocalStorage.authtoken
		},
	...
	var reqMinisterios = {
		method: 'GET',
		url: 'https://tesis-rn6b.onrender.com/api/final/ministerios/list',
		headers: {
			'Content-Type': 'application/json',
			'xauthtoken': userDataFromLocalStorage.authtoken
		},
	...
	var reqRoles = {
		method: 'GET',
		url: 'https://tesis-rn6b.onrender.com/api/final/roles/listRol/' + $scope.userData.rol,
		headers: {
			'Content-Type': 'application/json',
			'xauthtoken': userDataFromLocalStorage.authtoken
		},
	...
	var reqRolesTot = {
		method: 'GET',
		url: 'https://tesis-rn6b.onrender.com/api/final/roles/list',
		headers: {
			'Content-Type': 'application/json',
			'xauthtoken': userDataFromLocalStorage.authtoken
		},
	...
	$scope.nuevoEst = function () {
		...
		var req = {
			method: 'POST',
			url: 'https://tesis-rn6b.onrender.com/api/final/estimulos/nuevoEstimulo',
			headers: {
				'Content-Type': 'application/json',
				'xauthtoken': userDataFromLocalStorage.authtoken
			},
	...
	$scope.nuevoDoc = function () {
		...
		if (!form.checkValidity()) {
			...
			var req = {
				method: 'POST',
				url: 'https://tesis-rn6b.onrender.com/api/final/documentos/nuevoDocumento',
				headers: {
					'Content-Type': 'application/json',
					'xauthtoken': userDataFromLocalStorage.authtoken
				},
	...
	$scope.verDocumentos = function (i) {
		...
		var obtenerEst = {
			method: 'GET',
			url: 'https://tesis-rn6b.onrender.com/api/final/estimulos/obtenerEstimulo/' + i,
			headers: {
				'Content-Type': 'application/json',
				'xauthtoken': userDataFromLocalStorage.authtoken
			},
		...
		var reqDocs = {
			method: 'GET',
			url: 'https://tesis-rn6b.onrender.com/api/final/documentos/list/' + i + "/" + userDataFromLocalStorage.idUser,
			headers: {
				'Content-Type': 'application/json',
				'xauthtoken': userDataFromLocalStorage.authtoken
			},
	...
	$scope.aprobar = function (i, id) {
		...
		var req = {
			method: 'PUT',
			url: 'https://tesis-rn6b.onrender.com/api/final/documentos/cambiarEstado/' + id + "/2",
			headers: {
				'Content-Type': 'application/json',
				'xauthtoken': userDataFromLocalStorage.authtoken
			}
		...
		$scope.Ejecutar(req).
			then(function (resp) {
				...
				req = {
					method: 'PUT',
					url: 'https://tesis-rn6b.onrender.com/api/final/estimulos/cambiarEstado/' + i,
					headers: {
						'Content-Type': 'application/json',
						'xauthtoken': userDataFromLocalStorage.authtoken
					}
	...
	$scope.leida = function (id) {
		...
		var req = {
			method: 'PUT',
			url: 'https://tesis-rn6b.onrender.com/api/final/notificacionesUsuario/leida/' + id + "/" + userDataFromLocalStorage.idUser,
			headers: {
				'Content-Type': 'application/json',
				'xauthtoken': userDataFromLocalStorage.authtoken
			}
	...
	$scope.noticias = function () {
		var reqNoticias = {
			method: 'GET',
			url: 'https://tesis-rn6b.onrender.com/api/final/noticias/list',
			headers: {
				'Content-Type': 'application/json',
				'xauthtoken': userDataFromLocalStorage.authtoken
			},
	...
	$scope.rechazar = function (i, id) {
		...
		req = {
			method: 'PUT',
			url: 'https://tesis-rn6b.onrender.com/api/final/documentos/cambiarEstado/' + id + "/3",
			headers: {
				'Content-Type': 'application/json',
				'xauthtoken': userDataFromLocalStorage.authtoken
			}
	...
	$scope.nuevaNoticia = function () {
		...
		if (form=="") {
			...
			var req = {
				method: 'POST',
				url: 'https://tesis-rn6b.onrender.com/api/final/noticias/nuevaNoticia',
				headers: {
					'Content-Type': 'application/json',
					'xauthtoken': userDataFromLocalStorage.authtoken
				},
	...
	$scope.llenarMinisterio = function () {
		...
		var reqDocs = {
			method: 'GET',
			url: 'https://tesis-rn6b.onrender.com/api/final/permisos/get/' + $scope.selectedDestinatario.id,
			headers: {
				'Content-Type': 'application/json',
				'xauthtoken': userDataFromLocalStorage.authtoken
			},
	...
	$scope.verUltEstimulo = function () {
		...
		var obtenerEst = {
			method: 'GET',
			url: 'https://tesis-rn6b.onrender.com/api/final/estimulosSimpleAccess/load',
			headers: {
				'Content-Type': 'application/json',
				'xauthtoken': userDataFromLocalStorage.authtoken
			},
